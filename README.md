...
- The ICS decoy's VNC password-guessing campaign held its volume (1,293,885 attempts, +6.2% on a corrected July baseline — see below) but changed composition entirely: the autonomous system dominant through July went silent from 21 August, replaced by a broad cloud cluster and a synchronized new group of twelve geographically diverse hosts; zero successful authentications were recorded for the month
...
- The Docker-API worm operator known from previous reports did not retreat when Docker volume fell 33% — it shifted its primary delivery channel to direct SSH brute-forcing over the same drop zone and ASN, and callbacks to its current C2 were recorded from 5 to 29 August, dominating the month's C2-activity list by more than an order of magnitude
...
- The month ended with two synchronized withdrawals and one anomaly: the leading SSH brute-force operator wound down over 29–31 August (from ~36,000 weight units per day to under a hundred), the Docker-worm C2 and its executor host both disappeared from our logs after 29 August, and on 31 August a single Brazilian consumer-network address that had not appeared all month opened 24,448 SSH sessions against one node without a single successful login or executed command. Whether the two withdrawals are shutdowns or another infrastructure rotation cannot be settled from August data alone
...
| Type | Value |
|------|-------|
| IP (LLM abuse, Ollama) | `147[.]45[.]69[.]42` (AS210644, sanctioned — 48% of month's volume), `168[.]144[.]135[.]119`, `156[.]239[.]42[.]225`, `136[.]243[.]10[.]183`, `74[.]80[.]181[.]141`, `199[.]217[.]105[.]247` |
...
| IP (SSH brute-force / droppers) | `171[.]244[.]44[.]251`, `213[.]232[.]114[.]14`, `176[.]65[.]139[.]228`, `94[.]154[.]43[.]231`, `130[.]12[.]180[.]51`, `64[.]112[.]184[.]210`, `83[.]237[.]93[.]10`, `201[.]48[.]108[.]11` (single-source flood, 31 Aug) |
...
| IP (Docker-API worm / VPSVAULT) | `5[.]182[.]210[.]174` (current C2, callbacks observed 5–29 Aug, none over the final two days of the month), `5[.]182[.]210[.]61`, `45[.]198[.]224[.]26`, `45[.]198[.]224[.]5`, `154[.]90[.]70[.]254`, `45[.]205[.]1[.]240`, `154[.]54[.]100[.]247`, `217[.]60[.]195[.]113`, `101[.]33[.]245[.]191`, `167[.]86[.]122[.]134` |
...
*Unlike previous releases, publication of currently active command-and-control infrastructure has been explicitly approved for this report cycle — the VPSVAULT operator's C2 above drew bot callbacks from 5 to 29 August, then went quiet on our sensors for the final two days of the month; absence of callbacks is not a confirmed takedown, and the address may simply have rotated as it did once already. What remains withheld is anything that would reveal the location, architecture, or composition of our own sensors.*
